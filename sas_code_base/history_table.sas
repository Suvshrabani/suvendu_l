...
/* 7. Store data field information for column level cleansup */
	/* ML added the &lib_prxto seperate dw and dwh systems */
...
/*unnecessary step. remove to avoid table lock. Miaomiao, 2023-08-18  
	proc sql noprint ;
		delete from &lib_prx._ctrl.datafields
		where library="&library."
			and tablename="&tablename."
			and active_date not in (&history_dates.);
	quit;

	proc append base=&lib_prx._ctrl.datafields data=fields_2; run;*/		
